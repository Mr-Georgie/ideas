            ...
            {sent ? (
              ...
              <>
                ...
                <div className="f-body" style={{ fontSize: 13, color: 'var(--ink-2)', marginBottom: 18 }}>
                  no password. no algorithms. just ideas.
                </div>

                {/* Google — coming soon; keep signInWithGoogle wired for when OAuth is enabled */}
                <div style={{
                  width: '100%', padding: '11px 0', marginBottom: 14,
                  border: '2px dashed var(--ink-3)', position: 'relative',
                  ...
                  <span className="f-mono" style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.08em', color: 'var(--ink-2)' }}>
                    GOOGLE — COMING SOON
                  </span>
                  <span style={{
                    position: 'absolute', top: -8, right: 10,
                    fontFamily: "'JetBrains Mono', monospace", fontSize: 8, fontWeight: 700,
                    letterSpacing: '0.1em', color: 'var(--ink-3)', background: 'var(--paper)',
                    padding: '0 4px',
                  }}>SOON</span>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
                  ...
                  <div className="f-mono" style={{ fontSize: 9, color: 'var(--ink-3)', letterSpacing: '0.12em' }}>OR</div>
                  <div style={{ flex: 1, height: 0, borderBottom: '1.5px dashed var(--ink-3)' }} />
                </div>

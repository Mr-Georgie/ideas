...
export default function SignUp(props) {
  ...
  // instance 2
  const {
    inputOnFocus: usernameOnFocus,
    onFocusHandler: usernameOnFocusHandler,
    ref: usernameRef,
    handleClick: usernameHandleClick,
  } = useInputEvent();
      ...
      <section className="flex flex-col items-center justify-center">
        ...
        >
          <div className="">
            ...
            <div
              className={`bg-gray-800 px-2 rounded-md border mb-4 cursor-pointer ${
                usernameOnFocus ? "border-custom-indigo" : "border-gray-700"
              }`}
            ...
            >
              <div className="flex">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className={`h-4 w-4 m-3 ${
                    usernameOnFocus ? "text-custom-indigo" : "text-custom-white"
                  }`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"

      ...
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        ...
        {error && (
          <div style={{ padding: "60px 0", textAlign: "center" }}>
            <div
              className="f-display"
              style={{ fontSize: 24, color: "var(--red)" }}
            >
              couldn't load ideas.
            </div>
            <div
        ...
        {!loading && !error && ideas.length === 0 && (
          <div style={{ padding: "60px 0", textAlign: "center" }}>
            <div
              className="f-display"
              style={{ fontSize: 28, color: "var(--ink-2)" }}
            >
              nothing here yet.
            </div>
            <div
        ...
        {!loading && ideas.length > 0 && (
          <div style={{ textAlign: "center", marginTop: 60 }}>
            ...
            <div
              className="f-display"
              style={{ fontSize: 26, color: "var(--ink-2)", marginTop: 8 }}
            >
              come back tomorrow.
            </div>
          </div>
    ...
    >
      ...
      {posting && (
        ...
        >
          ...
          >
            <PostFlow onClose={onClosePost} onPosted={onPosted} remixOf={remixOf} />
          </div>
        </div>
      )}
